...
public class GeneralStatsPanel extends JPanel implements Variables {
    ...
    public GeneralStatsPanel(Civilization civ, MainFrame frame) {
        ...
        content_panel.add(createStatCard("Magician", lbl_magician, "./M3/images/magician_civ.png", 80, 80));
        content_panel.add(createStatCard("Priest", lbl_priest, "./M3/images/priest_civ.png", 120, 80));
        ...
        content_panel.add(createSectionTitle("GENERATION RESOURCES/ per minute"));
    ...
    private int getWoodGeneration() {
        ...
        return CIVILIZATION_WOOD_GENERATED+ civ.getCarpentry() * CIVILIZATION_WOOD_GENERATED_PER_CARPENTRY;
    }

    private int getIronGeneration() {

        return CIVILIZATION_IRON_GENERATED + civ.getSmithy() * CIVILIZATION_IRON_GENERATED_PER_SMITHY;
    }
